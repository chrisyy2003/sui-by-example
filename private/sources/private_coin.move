...
/// `borrow_mut()` and `zero()`.
module private::private_coin {
    use sui::transfer;
    use sui::tx_context::{Self, TxContext};
    use sui::object::{Self, UID};
    use private::private_balance::{Self, PrivateBalance, Supply};
...
#[test_only]
module private::private_coin_tests {
    use sui::test_scenario::{Self as test, Scenario, next_tx, ctx};
    use private::private_coin::{Self as pc};
    use private::private_balance::{Self as pb};
    use sui::transfer;
